...
const FileField: FC<FileFieldPropsType> = ({save}) => {
    ...
    const changeHandler = (setFieldValue: (file: string, values: Partial<File>) => void) => (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        <Formik
            ...
            {({handleSubmit, setFieldValue, values, isSubmitting}) => (
                <Form onSubmit={handleSubmit}>
                    ...
                    <input name="file" type="file" id="file" className='d-none'
