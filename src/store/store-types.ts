...
export const SET_OWNER_STATUS: string = 'SB/PROFILE/SET_OWNER_STATUS';

export const GET_PROFILE_STATUS: string = 'SB/PROFILE/GET_PROFILE_STATUS';
export const SET_PROFILE_STATUS: string = 'SB/PROFILE/SET_PROFILE_STATUS';
